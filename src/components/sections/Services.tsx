...
const services: Service[] = [
  ...
  },
  {
    ...
    desc: "Diseño a medida, ensamblaje y testeo de cuadros de automatización, control y distribución de potencia.",
    icon: <Layers className="h-8 w-8" />,
    color: "#22d3ee",
  },
  {
    title: "Redes y Fibra Óptica",
    desc: "Cableado estructurado certificado e infraestructuras críticas de transmisión de datos para la industria.",
